const dados = [
    ...
    },
    {
        ...
        descricao: [
            '<a href="https://www.youtube.com/@CursoemVideo/playlists" target="_blank">Curso em Video</a>',
            '<a href="https://www.youtube.com/@HostGatorAcademy" target="_blank">HostGator Academy</a>'

        ],
        imagem: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiAO8PXhXyOOZZTdtxzI26ZlciC7FA5L_cZpDSvaEA6Q&s"
    },
    {
        titulo: "JavaScript",
        descricao: [
    ...
    },
    {
        ...
        descricao: [
            ...
            '<a href="https://www.youtube.com/@UmInventorQualquer" target="_blank">Um Inventor Qualquer</a>',
            '<a href="https://www.youtube.com/@CloudTreinamentos" target="_blank">Cloud Treinamentos</a>',
            '<a href="https://www.youtube.com/@academind/playlists" target="_blank">Academind</a>',
        ],
    ...
    },
    {
        titulo: "SAP",
        descricao: [
            '<a href="https://www.youtube.com/@diegonogueiraDJ/playlists" target="_blank">Diego Nogueira</a>',
        ],
        imagem: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/SAP_2011_logo.svg/1200px-SAP_2011_logo.svg.png"
    },
    {
        titulo: "C++",
        descricao: [
    ...
    },
    {
        ...
        descricao: [
            '<a href="https://www.youtube.com/@minutoagil/playlists" target="_blank">minutoagil</a>',
            '<a href="https://www.youtube.com/@CANALVALOR" target="_blank">CANAL VALOR</a>'
        ],
    ...
    },
    {
        titulo: "CI/CD",
        descricao: [
            '<a href="https://www.youtube.com/@TechWorldwithNana/playlists" target="_blank">TechWorld with Nana</a>',
        ],
        imagem: "https://upload.wikimedia.org/wikipedia/commons/9/9c/Continuous_Integration.jpg"
    },
    {
        titulo: "Docker",
        descricao: [
    ...
    },
    {
        ...
        descricao: [
            ...
            '<a href="https://www.youtube.com/@EnglishBay" target="_blank">EnglishBay</a>',
            '<a href="https://www.youtube.com/@CursoemVideo/playlists" target="_blank">Curso em Video</a>',
        ],
